...
Si dos equipos distintos sonifican el mismo agujero negro, ¿estamos escuchando el mismo fenómeno? ¿Por qué suena grave, por qué tiene ese ritmo, por qué es continuo o pulsado? Nada de eso está en los datos en sí, sino en las decisiones de interfaz que los hacen perceptibles. Con los mismos datos pueden construirse experiencias radicalmente distintas, lo que evidencia que no accedemos al fenómeno directamente, sino a su interpretación computacional. La sonificación no revela el espacio: define cómo puede ser experimentado. Y es precisamente ahí, en esa fusión entre dato científico, lenguaje sonoro y decisión cultural mediada por software, donde Manovich (2008) sitúa el núcleo de la hibridación.
